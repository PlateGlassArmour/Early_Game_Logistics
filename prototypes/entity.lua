data:extend ({
{
    ...
    icon = "__Early_Game_Logistics__/graphics/entity/simple-chest-passive-provider.png",
    icon_size = 32,
    ...
    picture =
    {
      filename = "__Early_Game_Logistics__/graphics/entity/simple-chest-passive-provider.png",
      priority = "extra-high",
      width = 38,
      height = 32,
      shift = {0.09375, 0}
...

 {
    ...
    icon = "__Early_Game_Logistics__/graphics/entity/simple-chest-active-provider.png",
    icon_size = 32,
    flags = {"placeable-player", "player-creation"},
    ...
    picture =
    {
      filename = "__Early_Game_Logistics__/graphics/entity/simple-chest-active-provider.png",
      priority = "extra-high",
      width = 38,
      height = 32,
      shift = {0.09375, 0}
...

{
    ...
    icon = "__Early_Game_Logistics__/graphics/entity/simple-chest-storage.png",
    icon_size = 32,
    flags= {"placeable-player", "player-creation"},
    ...
    picture =
    {
      filename = "__Early_Game_Logistics__/graphics/entity/simple-chest-storage.png",
      priority = "extra-high",
      width = 38,
      height = 32,
      shift = {0.09375, 0}
    ...
    
  {
    ...
    icon = "__Early_Game_Logistics__/graphics/entity/simple-chest-buffer.png",
    icon_size = 32,
    flags= {"placeable-player", "player-creation"},
    ...
    picture =
    {
      filename = "__Early_Game_Logistics__/graphics/entity/simple-chest-buffer.png",
      priority = "extra-high",
      width = 38,
      height = 32,
      shift = {0.09375, 0}
  ...
  
{
    ...
    icon = "__Early_Game_Logistics__/graphics/entity/simple-chest-requester.png",
    icon_size = 32,
    flags= {"placeable-player", "player-creation"},
    ...
    picture =
    {
      filename = "__Early_Game_Logistics__/graphics/entity/simple-chest-requester.png",
      priority = "extra-high",
      width = 38,
      height = 32,
      shift = {0.09375, 0}
  ...
  
{
    ...
    icon = "__Early_Game_Logistics__/graphics/icons/logistic-beacon.png",
	icon_size = 32,
    flags = {"placeable-player", "player-creation"},
	...
	layers = {
        {
          filename = "__Early_Game_Logistics__/graphics/entity/logistic-beacon.png",
          priority = "extra-high",
          width = 59,
          height = 178,
        ...
        {
          filename = "__Early_Game_Logistics__/graphics/entity/logistic-beacon-shadow.png",
          priority = "extra-high",
          width = 119,
          height = 25,
    ...
    base_patch =
    {
      filename = "__Early_Game_Logistics__/graphics/entity/blank.png",
      priority = "low",
      width = 1,
      height = 1,
      frame_count = 1
  ...
  
  {
    type = "roboport",
    name = "logistic-tower",
    icon = "__Early_Game_Logistics__/graphics/icons/logistic-tower.png",
	icon_size = 32,
    flags = {"placeable-player", "player-creation"},
	...
	layers = {
        {
          filename = "__Early_Game_Logistics__/graphics/entity/logistic-tower.png",
          priority = "extra-high",
          width = 150,
          height = 300,
        ...
        {
          filename = "__Early_Game_Logistics__/graphics/entity/logistic-tower-shadow.png",
          priority = "extra-high",
          width = 350,
          height = 94,
  ...
  
  {
    type = "roboport",
    name = "robocharger",
    icon = "__Early_Game_Logistics__/graphics/icons/robocharger.png",
	icon_size = 32,
    flags = {"placeable-player", "player-creation"},
	...
	layers = {
        {
          filename = "__Early_Game_Logistics__/graphics/entity/robocharger.png",
          priority = "extra-high",
          width = 135,
          height = 270,
        ...
        {
          filename = "__Early_Game_Logistics__/graphics/entity/robocharger-shadow.png",
          priority = "extra-high",
          width = 370,
          height = 104,
  ...
  
  {
    ...
    icon = "__Early_Game_Logistics__/graphics/icons/logistic-long-range-transmitter.png",
	icon_size = 32,
    flags = {"placeable-player", "player-creation"},
	...
	layers = {
        {
          filename = "__Early_Game_Logistics__/graphics/entity/logistic-long-range-transmitter.png",
          priority = "extra-high",
          width = 150,
          height = 300,
          shift = util.by_pixel(1, -50),
        ...
        {
          filename = "__Early_Game_Logistics__/graphics/entity/logistic-long-range-transmitter-shadow.png",
          priority = "extra-high",
          width = 350,
          height = 94,
          shift = util.by_pixel(60, 5),
  ...
  
  {
    type = "roboport",
    name = "logistic-hub",
    icon = "__Early_Game_Logistics__/graphics/icons/logistic-hub.png",
	icon_size = 32,
    flags = {"placeable-player", "player-creation"},
	...
	layers = {
        {
          filename = "__Early_Game_Logistics__/graphics/entity/logistic-hub.png",
          priority = "extra-high",
          width = 228,
          height = 277,
  ...
  
  {
    ...
    icon = "__Early_Game_Logistics__/graphics/icons/bumble-bot-base.png",
	icon_size = 32,
    flags = {"placeable-player", "player-creation"},
  ...
  
  {
    ...
    icon = "__Early_Game_Logistics__/graphics/icons/bumble-bundle-bot.png",
    icon_size = 32,
    ...
    idle =
    {
        filename = "__Early_Game_Logistics__/graphics/entity/bumble-bundle-bot.png",
        priority = "high",
        line_length = 16,
        width = 80,
        height = 84,
...

  {
    ...
    icon = "__Early_Game_Logistics__/graphics/icons/bumble-builder-bot.png",
    icon_size = 32,
    flags = {"placeable-player", "player-creation", "placeable-off-grid", "not-on-map"},
    ...
    idle =
    {
        filename = "__Early_Game_Logistics__/graphics/entity/bumble-builder-bot.png",
        priority = "high",
        line_length = 16,
        width = 66,
        height = 76,
    ...
    working =
    {
        filename = "__Early_Game_Logistics__/graphics/entity/bumble-builder-bot-working.png",
        priority = "high",
        line_length = 2,
        width = 57,
        height = 74,
